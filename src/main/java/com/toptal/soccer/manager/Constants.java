...
public class Constants {
    ...
    public static final String START_AND_PAGE_SIZE_HAVE_TO_BE_GREATER_THAN_ZERO = "Start and page size have to be greater than zero";
    public static final String USER_DOESN_T_HAVE_A_TEAM = "User doesn't have a team";
